...
<body>
	...
	<div id="content">
		...
		<div id="main_content">
			...
			<div id"pv_title">
				<div class="photo_title1"><h1><a href="photos_videos.php">PHOTOS</a></h1></div>
				<div class="video_title1"><h1><a href="#">VIDEOS</a></h1></div>
			</div>


				
				<iframe style="margin-left: 200px;" class"video_div" width="560" height="315" src="http://www.youtube.com/embed/k6GkOchLJBM" frameborder="0" allowfullscreen></iframe>
